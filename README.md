...
It is very fast, running on my "AMD Ryzen 5 2600X" CPU it was able to perform 215k additions per sec, 153k subtractions per sec, 292k multiplications per sec, 39k divisions per sec, 698k modulos per sec, 64k powers per sec and 96 roots per sec, all with a precision of 20 digits, very impressive. I know the roots are much slower than the other operations, but it is still quite fast.
